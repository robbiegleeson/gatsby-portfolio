    ...
    <>
      ...
      <Intro>
        <Container>
          <Headline>
            <Typed
              ...
              strings={[
                ...
                "I'm a <span class='accent'>Senior Software Engineer</span>.",
              ]}
              smartBackspace
              backDelay={1000}
              loopCount={0}
          ...
          <Text>
            I'm currently working for <a href="https://www.servisbot.com/" target="_blank">ServisBOT</a> as a Senior Software Engineer, working to continously improve customer interactions using conversational AI.{' '}
            <strong>
