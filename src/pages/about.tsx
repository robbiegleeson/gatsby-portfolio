...
const About = () => {
  ...
  return (
    <>
      ...
      <Container>
        <Section>
          <Name data-testid="headline">Hi, I'm Rob Gleeson</Name>
          <JobTitle>A Lead Software Developer from Ireland</JobTitle>
          <Text>
            I am a passionate Software Developer who creates amazing websites
            and web applications that solve problems for my clients. I am an
            advocate for web performance and accessibility as well as a
            JavaScript enthusiast with experience in serverless technologies.
          </Text>
          <Text>
            The technologies I work with are JavaScript,
            HTML and CSS with a focus on the frameworks React.js, Gatsby, Node and Express. I use code not only to do my day-to-day
